...
const uni = [];
for (i = 0; i < graduates.length; i++) {
  graduates[i].university.includes('Uni') ? uni.push(graduates[i].university) : 0
}
console.log(uni);
...
*/
const animalNames = [];
zooAnimals.forEach ((animal) => animalNames.push(animal.animal_name + ', Scientific: ' + animal.scientific_name))
